...
class BasketballTopTeamsScreen extends StatefulWidget {
  const BasketballTopTeamsScreen({super.key});

  @override
  State<BasketballTopTeamsScreen> createState() => _BasketballTopTeamsScreenState();
}

class _BasketballTopTeamsScreenState extends State<BasketballTopTeamsScreen> {
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.stars, color: Color(0xFFE65100), size: 18),
                        SizedBox(width: 8),
                        Text(
                          'FIBA World Rankings',
                          style: TextStyle(
                    ...
                    Text(
                      'Official Basketball National Teams',
